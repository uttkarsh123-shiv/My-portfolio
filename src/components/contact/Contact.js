        ...
        <div className='contact__content'>
          <div className='contact__info'>
            <div className='contact__card'>
              ...
              <a href='mailto: uttkarshsingh450@gmail.com' target="_blank" rel="noreferrer" className='contact__button'> Write me{" "}
            ...
            <div className='contact__card'>
              ...
              <span className='contact__card-data'>+91 9582189958</span>
